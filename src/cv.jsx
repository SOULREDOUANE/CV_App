...
function Cv() {
  return (
    <div>
        ...
        <div className='separatoin'></div>
        <div className="container">
        <div className="Profile">
            <div  className="profile">
                <img className="image_profile" src={profile} alt=""/>
                <h2 className="name">{data.prenom +" "+data.nom}</h2>
                <h2 className='name'>{data.titre}</h2>
            </div>
        ...
        <div className="Main"> 
            <div>
                ...
                <p className="about_me">{data.about_me}</p>
            </div>
            ...
            <div>
                ...
                <h3 className="technique">Compétances Technique</h3>
                    ...
                    <div className="container_techinque">
                        <div className="skills"><ul><li>{data.competance_techn}</li></ul></div>
            ...
            <div>
                ...
                <h3 className="formation">Formation et Diplôme </h3>
                    ...
                    <ul>
                        <li className="list_formation">{data.formation}</li>
            ...
            {/* <i>actuallement&nbsp;</i>:&nbsp;Elève ingénieur d'état en génie informatique à l'Ecole Mohammaedia d'Ingénieur. */}
