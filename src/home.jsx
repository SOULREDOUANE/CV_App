...
function Home() {
  return (
    ...
    <div className='cv_ex'>voici un exemple de CV</div>
    <div className="contain_cv_exemple">
        <div className="container">
            <div className="Profile">
                <div  className="profile">
                    <img className="image_profile" src={profile} alt=""/>
                    <h2 className="name" id="title">SOUL Redouane</h2>
                    <h2 className="name" id="title">web developer</h2>
                </div>
                <div className="personal_detail">
                    <div className="personal"><h3>Information personnalisé</h3></div>
                        <div className="icons">
                            <div className="icon_age"><img src={calender} alt="" className="icon_size"/></div>
                            <div className="age">15 Décembre 2000 </div>
                        </div>
                    <div className="icons">
